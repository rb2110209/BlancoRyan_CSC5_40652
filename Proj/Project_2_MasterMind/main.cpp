...
int main(){
    ...
    for(int i=0;i<4;i++){
        ...
        switch(randomInt){
            ...
            // Set first case to equal blue "B"
            case 1:
                randomColor[i] = 'B';
                break;
                
            // Set second case to equal green "G"
            case 2:
                randomColor[i] = 'G';
                break;
                
            // Set third case to equal orange "O"
            case 3:
                randomColor[i] = 'O';
                break;
            
            // Set fourth case to equal purple "P"
            case 4:
                randomColor[i] = 'P';
                break;
            
            // Set fifth case to equal red "R"
            case 5:
                randomColor[i] = 'R';
                break;
                
            // Set sixth case to equal yellow "Y"
            case 6:
                randomColor[i] = 'Y';
                break;   
        }
    ...
    cout << "      Blue = B, Green = G, Orange = O," << endl;
    cout << "      Purple = P, Red = R, Yellow = Y" << endl << endl;
